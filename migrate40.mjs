...
const sql = await readFile(
  new URL('./supabase/migrations/20260722_automation_delays.sql', import.meta.url),
  'utf8',
)
...
try {
  ...
  if (process.env.MIGRATION_DRY_RUN === '1') {
    ...
    console.log('Migration 40 validée (simulation annulée).')
  } else {
    await client.query('COMMIT')
    console.log('Migration 40 terminée : automation_delays ajouté sur user_business_profiles.')
  }
} catch (error) {
  await client.query('ROLLBACK')
  throw error
