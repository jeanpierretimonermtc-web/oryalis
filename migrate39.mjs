...
const sql = await readFile(
  new URL('./supabase/migrations/20260722_order_type.sql', import.meta.url),
  'utf8',
)
...
try {
  ...
  if (process.env.MIGRATION_DRY_RUN === '1') {
    ...
    console.log('Migration 39 validée (simulation annulée).')
  } else {
    await client.query('COMMIT')
    console.log('Migration 39 terminée : order_type ajouté sur orders.')
  }
} catch (error) {
  await client.query('ROLLBACK')
  throw error
