  ...
  const { data: insertedClients, error: clientsErr } = await supabase
    ...
    .insert([
      // Niveau 1 — distributeurs directs
      {
        ...
        status: 'active', contact_role: ['distributor', 'leader'], pipeline_stage: 'distributor',
      ...
      },
      {
        ...
        status: 'active', contact_role: ['distributor'], pipeline_stage: 'distributor',
      ...
      // Niveau 2 — filleuls d'Emma
      {
        ...
        status: 'active', contact_role: ['customer'], pipeline_stage: 'customer',
      ...
      },
      {
        ...
        status: 'inactive', contact_role: ['distributor'], pipeline_stage: 'lost',
      ...
      // Cliente VIP
      {
        ...
        status: 'vip', contact_role: ['customer'], pipeline_stage: 'customer',
